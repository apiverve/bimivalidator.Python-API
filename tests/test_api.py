...
class TestBimivalidatorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = BimivalidatorAPIClient(self.api_key)

    @patch('apiverve_bimirecordvalidator.apiClient.requests.get')
